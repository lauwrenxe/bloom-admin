...
const s = {
  ...
  modal:  (w) => ({ background: "#fff", borderRadius: 16, width: "100%", maxWidth: w || 520, maxHeight: "92vh", overflow: "auto", boxShadow: "0 24px 64px rgba(0,0,0,0.22)" }),
  ...
  badgeCard:{ background: "#fff", borderRadius: 12, padding: "16px", border: `1px solid ${G.wash}`, display: "flex", alignItems: "center", gap: 14, boxShadow: "0 1px 4px rgba(0,0,0,0.04)" },
          ...
          <div style={s.modal(480)}>
            ...
            <div style={s.mBody}>
              ...
              <div style={{ background: G.wash, borderRadius: 8, padding: "10px 14px", fontSize: 12, color: G.dark }}>
                💡 A unique certificate code will be auto-generated.
              </div>
            </div>
            <div style={s.mFooter}>
            ...
            {badges.map(b => {
              ...
              return (
                <div key={b.id} style={s.badgeCard}>
                  <div style={{ width: 52, height: 52, borderRadius: 12, background: "#fef9c3", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 26, flexShrink: 0 }}>
                  ...
                  <div style={{ display: "flex", gap: 2 }}>
                    <button style={s.iconBtn(G.base)} onClick={() => openEdit(b)}>✏️</button>
                    <button style={s.iconBtn("#dc2626")} onClick={() => del(b)}>🗑️</button>
                  </div>
                </div>
              );
            })}
...
export default function CertificatesPage() {
  ...
  return (
    <div style={s.page}>
      <div style={s.header}>
        <div>
          <div style={s.title}>🏆 Certificates & Badges</div>
          <div style={{ fontSize: 13, color: "#888", marginTop: 2 }}>Manage student achievements and recognitions</div>
        </div>
      </div>
      <div style={s.tabs}>
        <div style={s.tab(tab === "certificates")} onClick={() => setTab("certificates")}>🏆 Certificates</div>
        <div style={s.tab(tab === "badges")}        onClick={() => setTab("badges")}>🏅 Badges</div>
      </div>
