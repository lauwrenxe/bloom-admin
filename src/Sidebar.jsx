...
function BloomLogo({ collapsed }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10, overflow: "hidden" }}>
      ...
      {!collapsed && (
        <div>
          <div style={{ fontSize: 15, fontWeight: 700, color: "#fff", letterSpacing: ".3px", lineHeight: 1 }}>
            BLOOM
          </div>
          <div style={{ fontSize: 9, color: "rgba(255,255,255,.4)", letterSpacing: "1px", textTransform: "uppercase", marginTop: 2 }}>
            GADRC CvSU
          </div>
        </div>
      )}
...
export default function Sidebar({ active, setActive, onLogout, user }) {
  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        {!collapsed && (
          <button
            ...
            style={{ background: "none", border: "none", color: T.railText, cursor: "pointer", padding: 4, borderRadius: 4, display: "flex", alignItems: "center", lineHeight: 1, transition: "color .15s" }}
        ...
        {collapsed && (
          <button
            ...
            style={{ background: "none", border: "none", color: T.railText, cursor: "pointer", padding: 0, display: "flex", transition: "color .15s" }}
            onMouseEnter={e => e.currentTarget.style.color = "#fff"}
            onMouseLeave={e => e.currentTarget.style.color = T.railText}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <line x1="3" y1="12" x2="21" y2="12"/>
              ...
              return (
                <div key={item.id} style={{ position: "relative" }}>
                  <button
                    ...
                    onMouseEnter={e => {
                      if (!isActive) {
                        e.currentTarget.style.background = T.railHover;
      ...
      {/* ── User + sign out ── */}
      <div style={{
        padding: collapsed ? "10px 6px 16px" : "10px 10px 16px",
        borderTop: `1px solid ${T.railBorder}`,
      }}>
        {!collapsed ? (
          <>
            <div style={{
              ...
              <div style={{
                ...
                background: `linear-gradient(135deg,${T.brand},${T.brandAccent})`,
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: 12, fontWeight: 600, color: "rgba(255,255,255,.88)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                  GADRC Admin
                </div>
                <div style={{ fontSize: 10, color: "rgba(255,255,255,.38)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                  {user?.email ?? ""}
                </div>
              </div>
            </div>
